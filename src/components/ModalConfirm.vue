<template>
    <div class="fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition flex items-center">
        <!-- overlay -->
        <div @click="handleConfirmOrder(false)" aria-hidden="true" class="fixed inset-0 w-full h-full bg-black/50 cursor-pointer">
        </div>
        <!-- Modal -->
        <div class="relative w-full cursor-pointer pointer-events-none transition my-auto mt-48 p-4">
            <div class="w-full py-2 bg-white cursor-default pointer-events-auto dark:bg-gray-800 relative rounded-xl mx-auto max-w-sm">
                <button @click="handleConfirmOrder(false)" tabindex="-1" type="button" class="absolute top-2 right-2 rtl:right-auto rtl:left-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="px-6 py-2">
                        <div class="grid gap-2 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                            <button @click="handleConfirmOrder(false)" type="button"
                            ...
                            <button v-else-if="type == 'danger'" @click="handleConfirmOrder(true)" type="button"
...
const emit = defineEmits(['confirmModal']);
